...
const Navbar = () => {
  ...
  return (
    <nav className="shadow-md bg-white dark:bg-gray-900 dark:text-white">
        ...
        <div className="hidden md:flex items-center gap-6 text-lg font-medium">
          ...
          {user ? (
            <div className="relative group cursor-pointer">
              ...
              {/* Dropdown */}
              <div className="absolute right-0 mt-3 w-44 bg-white dark:bg-gray-800 shadow-lg rounded-md hidden group-hover:block">
        ...
        <div className="md:hidden px-4 pb-4 space-y-4 text-lg">
          ...
          {user ? (
            <div className="mt-3">
              ...
              <Link
                to="/dashboard"
                className="block mt-2 hover:text-blue-500"
              >
                Dashboard
              </Link>
